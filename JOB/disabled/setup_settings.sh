...
export PGDATA=/home/a.rybakina/postgres_data_job
$INSTDIR/psql -d test_db -c "ALTER SYSTEM SET aqo.mode = 'disabled'"
$INSTDIR/psql -d test_db -c "ALTER SYSTEM SET aqo.force_collect_stat = 'on'"
$INSTDIR/psql -d test_db -c "ALTER SYSTEM SET aqo.show_details = 'on'"
$INSTDIR/psql -d test_db -c "ALTER SYSTEM SET aqo.show_hash = 'on'"
...
$INSTDIR/psql -d test_db -c "select aqo_reset();"

$INSTDIR/psql -d test_db -c "SELECT pg_reload_conf();"
